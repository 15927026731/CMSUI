...
class REQUEST:
    ...
    def logincookie(self):
        ...
        cookie = {"cookie": str(name)+"username=" + str(cookie1) + "; "+str(name)+"userid=" + str(cookie2) + "; "+str(name)+"groupid="
                            + str(cookie3) + "; "+str(name)+"rnd=" + str(cookie4) + "; "+str(name)+"auth=" + str(cookie5)}
        return cookie

    def add(self):
        url="http://127.0.0.1:8080/e/DoInfo/ecms.php"
        data={"enews":"MAddInfo","classid":"12","id":"0","filepass":"1701246164","mid":"80","title":"123","smalltext":"测试内容测试内容"
              ,"myarea":"东城区","email":"524979780@qq.com","mycontact":"15927026731","address":"杭州西湖","addnews":"提交"}
